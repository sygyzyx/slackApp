...
const app = new App({
    token: process.env.SLACK_BOT_TOKEN_mainApp,
    signingSecret: process.env.SLACK_SIGNING_SECRET_mainApp,
    socketMode: true, 
    appToken: process.env.SLACK_APP_TOKEN_mainApp,
...
//Event runs when the user mentions the App
